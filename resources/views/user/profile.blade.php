                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="content_block">
                            <div class="title primary-text-color"><h2>Понравившиеся фильмы ({{$liked_movies->total()}})</h2>
                                <hr class="divider-color">
                            </div>
                            <div class="row">
                                @forelse($liked_movies as $movie)
                                    @include('partials.movie_list',['movie'=>$movie])
                                @empty
                                    <div class="col-lg-8 col-lg-offset-2 empty_message">Список пуст. <br>Нажимая кнопку "Нравится" на страницу филма, Вы добавите его в этом списке.
                                    </div>
                                @endforelse
                            </div>
                            <div class="actions">
