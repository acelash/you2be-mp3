                            ...
                            <form id="edit_user" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data" method="POST"
                                ...
                                <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-18">
                                        <input type="text" name="title" required="required" value="{{ old('title') }}"  class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                ...
                                <div class="form-group{{ $errors->has('slug') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-18">
                                        <input type="text" name="slug" required="required" value="{{ old('slug') }}"  class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                ...
                                <div class="form-group{{ $errors->has('ord') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-18">
                                        <textarea id="content" rows="20" name="content" class="form-control">{{ old('content') }}</textarea>
                                    </div>
                                </div>
